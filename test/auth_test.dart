...
void main () {
  ...
  group ('Mock Authentication', () {
    ...
    test("Create user should delegate to logIn function", () async {
      final badEmailUser = provider.createUser(email: "dhrubi@baby.com", password: "anypassword",);
      expect(badEmailUser, throwsA(const TypeMatcher<InvalidCredentialAuthException>()));
      final badPasswordUser = provider.createUser(email: "someone@baby.com", password: "dhrubibaby");
      expect(badPasswordUser, throwsA(const TypeMatcher<InvalidCredentialAuthException>()));
      final user = await provider.createUser(email: "dhrubi", password: "baby");
...
class MockAuthProvider implements AuthProvider{
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    if(!isInitialized) throw NotInitializedException();
    if (email == "dhrubi@baby.com") throw InvalidCredentialAuthException();
    if (password == "dhrubibaby") throw InvalidCredentialAuthException();
    const user = AuthUser(id: 'my_id', isEmailVerified: false, email: 'dhrubi@baby.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(id: 'my_id', isEmailVerified: true, email: 'dhrubi@baby.com');
    _user = newUser;
  }
